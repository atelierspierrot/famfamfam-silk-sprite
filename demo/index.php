...
<head>
    ...
    <title>FamFamFam Silk icons CSS sprites</title>
	...
	<link rel="stylesheet" href="../src/silk-icons-sprite.css" />
<!--
	<link rel="stylesheet" href="../src/silk-icons-sprite.min.css" />
//-->
...
<body>
    ...
    <header id="top" role="banner">
        <hgroup>
            <h1>FamFamFam Silk icons CSS sprite demo</h1>
	...
	<nav>
        ...
        <ul id="navigation_menu" class="menu" role="navigation">
            ...
            <li><a href="http://github.com/atelierspierrot/famfamfam-silk-sprite">Sprites sources</a></li>
        </ul>
...
foreach ($icons_list as $class) {
    echo <<<EOT
        <li><a href="#$class" title="$class"><span class="web-icon reset $class"></span></a></li>
EOT;
}
?>
    </ul>
...
<pre style="font-weight: bold; text-align: center;">
    ...
    <footer id="footer">
		...
		<div class="credits float-right">
            <a href="http://www.famfamfam.com/lab/icons/silk/">FamFamFam Silk icons</a> package by <a href="http://www.famfamfam.com">FamFamFam</a> under <a href="http://creativecommons.org/licenses/by/3.0/">CC-BY 3.0</a> license.
            <br />
            <a href="http://github.com/atelierspierrot/famfamfam-silk-sprite">atelierspierrot/famfamfam-silk-sprite</a> package by <a href="http://github.com/atelierspierrot">Les Ateliers Pierrot</a> under <a href="http://creativecommons.org/licenses/by/3.0/">CC-BY 3.0</a> original license.
		</div>
    </footer>
